...
public class UsuarioControllerTest {
	...
	private static final String NOME = "Jessica";
	private static final String SOBRENOME = "Machado";
	private static final String EMAIL = "jessicacris.lm@gmail.com";
    ...
    public void create() throws Exception {
        ...
        mvc.perform(post(URL + "/" + ID)
                .contentType(MediaType.APPLICATION_JSON)
                .content("{ \"nome\": \"Jessica\", \"email\": \"jessicacris.lm@gmail.com\" }")
